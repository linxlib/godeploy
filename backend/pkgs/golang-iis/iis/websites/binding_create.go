...
func (c *WebsitesClient) AddBinding(websiteName string, ipAddress string, hostHeader string, port int) error {
	commands := fmt.Sprintf(`
Import-Module WebAdministration
New-WebBinding -Name %q -IPAddress %q -HostHeader %q -Port %d
